...
function changeTab() {
    for (var a = this.getAttribute("data-tab-id") - 1, b = document.querySelectorAll("ul.tabbed li.tab"), c = 0; c < b.length; c++) b[c].className = b[c].className.replace(/ +active/, "");
    b[a].className = b[a].className + " active";
}
...
for (var tab_anchors = document.querySelectorAll(".tabs"), i = 0; i < tab_anchors.length; i++) addEvent(tab_anchors[i], "click", changeTab);

var handle_scroll = function() {
    var a = document.body.scrollTop, b = a + get_viewport_height(), c = get_page_height(), d = document.querySelector("footer.site-footer");
